...
App = {
  ...
  initContract: async function() {
    ...
    var amacoinAddress = '0xB9996eeB5830ecB76955dFC9Dec06D459b57968f';
    ...
    generateAccount: function(){
      ...
      getBalance: function(addressId){
        App.contracts.AmaCoin.methods.balanceOf(addressId).call();
      },

      displayBalance: function(balance, employee){
        $("#infoAccountBalance").empty();
          $("#employeeAddressId").empty();
          $("#employeePosition").empty();
        $("#infoAccountBalance").append("<h3  class='text-center'>  Balance  </h3><br/>  <h1  class='text-center'>"+ balance +" AmaCoin  </h1><br/>");
        addr = employee.addressId;
        position = employee.position;
        $("#employeeAddressId").append("Your ID: " + addr);
        $("#employeePosition").append("Your position: " + position);
        if (balance == 0) {
